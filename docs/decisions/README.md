...
| [0010](ADR-0010-silver-quarantine-and-late-arrival-reconciliation.md) | Reason-Coded Quarantine (Not Drop) + Batch Late-Arrival Reconciliation Outside Lakeflow |
